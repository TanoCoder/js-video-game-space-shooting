...
// Structure d'état locale pour configurer le joueur avec ses dimensions réduites de moitié (65x40)
const hero = { 
  x: window.innerWidth / 2 - 32, // Position X initiale centrée sur l'écran
  y: window.innerHeight - 80,    // Position Y initiale placée vers le bas de l'écran
  speed: 500,                    // Vitesse de déplacement horizontale (pixels par seconde)
  isExploding: false,            // Vrai si le joueur a été touché et est en train d'exploser
  isProtected: false             // Vrai si le joueur possède son bouclier "GET READY !" actif
};
...
// Recalcul des proportions et du centrage dès que l'image du vaisseau est chargée par le navigateur
